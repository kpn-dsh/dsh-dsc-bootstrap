...
// Name of the project
name := "average-handling-time-processor"
...
/* Docker Build */
dockerRepository := Some("dataserviceshub-docker-dshdemo2.jfrog.io")
dockerBaseImage := DockerFile.baseImage
daemonUser in Docker := "dshdemo2"
daemonUserUid in Docker := Some("1025")
daemonGroup in Docker := "dshdemo2"
daemonGroupGid in Docker := Some("1025")
packageName in Docker := "average-handling-time-processor"
